...
/**
 * @Date 2023-11-26 11:32 星期日
 * @Author: 聂建强
 * @Description:  测试运算符的使用1：算术运算符的使用
 *
 * 1. +  -  +  -  *  /  %  (前)++  (后)++  (前)--  (后)--  +
 */
public class AriTest {
    public static void main(String[] args) {
        ...
        //编译不通过
        //s1 = s1 + 1;  // 加1 short+int 根据自动类型提升，结果应该是int类型,故编译不通过

        //s1 = (short)(s1 + 1);  // 可以将结果转成short，编译就通过了
